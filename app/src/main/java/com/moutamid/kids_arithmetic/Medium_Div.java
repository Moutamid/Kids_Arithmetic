...
public class Medium_Div extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medium_div);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (my_ans.isEmpty()){
                    Toast.makeText(Medium_Div.this, "Enter Your Answer Here...", Toast.LENGTH_SHORT).show();
                }
                else {
                    String counter_text_limit = counter_text.getText().toString().trim();
                    final int cnt = Integer.parseInt(counter_text_limit);
                    if (couter == cnt){
                        Intent intent = new Intent(Medium_Div.this , MainActivity.class);
                        startActivity(intent);
                        Toast.makeText(Medium_Div.this, "Successfully Finished...", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                    checkResult();
                }
    ...
    private void checkResult() {
        ...
        if (my_ans.equals(my_result)){
            Toast.makeText(Medium_Div.this, "Answer is Right !", Toast.LENGTH_SHORT).show();
            changeQuestion();
            increment_counter();
        }
        else {
            Toast.makeText(Medium_Div.this, "Answer is Wrong !", Toast.LENGTH_SHORT).show();
        }
    }
