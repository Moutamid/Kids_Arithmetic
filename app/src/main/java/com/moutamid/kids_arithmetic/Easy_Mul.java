...
public class Easy_Mul extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy_mul);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (my_ans.isEmpty()){
                    Toast.makeText(Easy_Mul.this, "Enter Your Answer Here...", Toast.LENGTH_SHORT).show();
                }
                else {
                    String counter_text_limit = counter_text.getText().toString().trim();
                    final int cnt = Integer.parseInt(counter_text_limit);
                    if (couter == cnt){
                        Intent intent = new Intent(Easy_Mul.this , MainActivity.class);
                        startActivity(intent);
                        Toast.makeText(Easy_Mul.this, "Successfully Finished...", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                    checkResult();
                }
    ...
    private void checkResult() {
        ...
        if (my_ans.equals(my_result)){
            Toast.makeText(Easy_Mul.this, "Answer is Right !", Toast.LENGTH_SHORT).show();
            changeQuestion();
            increment_counter();
        }
        else {
            Toast.makeText(Easy_Mul.this, "Answer is Wrong !", Toast.LENGTH_SHORT).show();
        }
    }
