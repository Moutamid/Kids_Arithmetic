...
public class Hard_Addition extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard_addition);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (my_ans.isEmpty()){
                    Toast.makeText(Hard_Addition.this, "Enter Your Answer Here...", Toast.LENGTH_SHORT).show();
                }
                else {
                    String counter_text_limit = counter_text.getText().toString().trim();
                    final int cnt = Integer.parseInt(counter_text_limit);
                    if (couter == cnt){
                        Intent intent = new Intent(Hard_Addition.this , MainActivity.class);
                        startActivity(intent);
                        Toast.makeText(Hard_Addition.this, "Successfully Finished...", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                    checkResult();
                }
    ...
    private void checkResult() {
        ...
        if (my_ans.equals(my_result)){
            Toast.makeText(Hard_Addition.this, "Answer is Right !", Toast.LENGTH_SHORT).show();
            changeQuestion();
            increment_counter();
        }
        else {
            Toast.makeText(Hard_Addition.this, "Answer is Wrong !", Toast.LENGTH_SHORT).show();
        }
    }
